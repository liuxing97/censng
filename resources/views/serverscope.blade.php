...
@section('pageMain')
    ...
    <div class="choicedAbout webServerType">
        <!--选择标题-->
        <div class="choicedTitle">网站开发</div>
        <!--选择介绍-->
    ...
    <div class="choicedAbout wechatServerType">
        <!--选择标题-->
        <div class="choicedTitle">微信开发</div>
        <!--选择介绍-->
        <div class="choicedMsg">
    ...
    <div class="choicedAbout appServerType">
        <!--选择标题-->
        <div class="choicedTitle">App开发</div>
        <!--选择介绍-->
        <div class="choicedMsg">
    ...
    <div class="choicedAbout zongheServerType">
        <!--选择标题-->
        <div class="choicedTitle">综合开发</div>
        <!--选择介绍-->
        <div class="choicedMsg">
    ...
    <div class="choicedAbout cehuaServerType">
        <!--选择标题-->
        <div class="choicedTitle">企业策划</div>
        <!--选择介绍-->
        <div class="choicedMsg">
