...
@section('contract')
    ...
    <div class="serverInfor">
        ...
        <div class="serverInformationCover">
            ...
            <div class="serverInformation">
                <div class="item"><span class="t">业务类型：</span><span class="v">模板购买-合同购买</span></div>
    ...
    <div class="priceBudget">
        ...
        <span class="v">￥<span class="jsAddPrice">700</span></span>
    </div>
    ...
    <div class="contract">
        ...
        <div class="contractMain">
            <div class="contactContractTitle">模板网站购买合同预览</div>
            <div class="contractPro">
                <div class="t">《辰象的象网络科技模板网站合同书》</div>
                <div class="v">
